...
#ifndef _MSC_VER
const int CreateRequest::kPlayerNameFieldNumber;
#endif  // !_MSC_VER
...
#ifndef _MSC_VER
const int CreateResult::kPlayerIdFieldNumber;
#endif  // !_MSC_VER
...
void CreateResult::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const CreateResult*>(&from));
}
...
::std::string CreateResult::GetTypeName() const {
  return "MyPacket.CreateResult";
}
